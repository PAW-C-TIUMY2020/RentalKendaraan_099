...
namespace RentalKendaraan_099.Controllers
{
    public class Customers1Controller : Controller
    {
        ...
        public Customers1Controller(RendKendaraanContext context)
        {
            _context = context;
        }
        ...
        {
            var rendKendaraanContext = _context.Customer.Include(c => c.IdGenderNavigation);
            return View(await rendKendaraanContext.ToListAsync());
        }
